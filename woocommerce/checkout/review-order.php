...
?>
<table class="shop_table woocommerce-checkout-review-order-table tabla-items-checkout">
	<thead>
		<tr>
			<th class="product-name"><?php esc_html_e( 'Product', 'woocommerce' ); ?></th>
			<th class="product-total"><?php esc_html_e( 'Cantidad', 'woocommerce' ); ?></th>
		...
		foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					<td class="product-name name-producto-flex">
					...
					<td class="product-total">
						<p style="text-align: center;"><?php echo $cart_item['quantity']; ?></p>
					</td>
					<td class="product-total">
